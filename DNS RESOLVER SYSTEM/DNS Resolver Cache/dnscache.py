...
bl_df= pd.read_csv("C:\\Users\\Anagha N Kishorw\\DNS-Filtering-System\\DNS RESOLVER SYSTEM\\DNS Resolver Cache\\blacklist.csv",usecols=['domain'])
wl_df= pd.read_csv("C:\\Users\\Anagha N Kishorw\\DNS-Filtering-System\\DNS RESOLVER SYSTEM\\DNS Resolver Cache\\whitelist.csv",usecols=['domain'])
